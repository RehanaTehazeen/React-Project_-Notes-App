  ...
  return (
    <div className="page home-page">
      ...
      <div className="categories-row">
        <button onClick={() => setSelectedCat("")} className={!selectedCat ? "active" : ""}>
          All
        </button>
        {CATEGORIES.map(c => (
          <button
            ...
            className={selectedCat === c ? "active" : ""}
          >
      ...
      <div className="notes-grid">
        {others.length
          ...
          : <div className="muted">No notes here. Create!</div>}
      </div>
    </div>
  );
}
